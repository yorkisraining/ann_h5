...
export default {
    data () {
        return {
            reportUrl: 'https://111.59.18.58:18501/sys/news/sys_news_main/sysNewsMain_manageList.jsp?type=category&categoryId=16c2833ee78b25ee6b17e5a4bf4bb138#cri.q=docStatus:30',
            height: 0,
            bottomNavList: [
                {
                name: 'home',
